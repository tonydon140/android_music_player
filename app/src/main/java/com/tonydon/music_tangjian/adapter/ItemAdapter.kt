...
class ItemAdapter : BaseQuickAdapter<MusicRecord, QuickViewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        Log.d("music", "onBindViewHolder...${item?.style}")
